            ...
            <Card sx={styles.item}>
                <CardContent>
                    ...
                    <Box sx={styles.postAuthorSection}>
                        <Avatar sx={styles.avatar} alt="meeee" src="src/assets/react.svg" />
                        <Typography sx={styles.postMeta}>React with derd dummy</Typography>
                        <Typography sx={styles.postMeta}>Jan 19, 2023</Typography>
                    </Box>
                    <Typography variant="body2">blaa blaa</Typography>
            ...
            <Card sx={styles.item}>
                <CardContent>
                    ...
                    <Box sx={styles.videoStatsRow}>
                        ...
                        <Typography variant="h7">$80000.00</Typography>
                    </Box>
                    <Divider sx={styles.divider} />
                    ...
                    <Box sx={styles.videoStatsRow}>
                        <Typography variant="h7">How to become a software developer in 202323</Typography>
                        <Typography variant="h7">450</Typography>
                    </Box>
                    <Box sx={styles.videoStatsRow}>
                        <Typography variant="h7">How to eat</Typography>
                        <Typography variant="h7">287</Typography>
                    </Box>
                    <Box sx={styles.videoStatsRow}>
                        <Typography variant="h7">choo hoo</Typography>
            ...
            <Card sx={styles.item}>
                <CardContent>
                    ...
                    <Box sx={styles.commentRow}>
                        <Avatar sx={styles.avatar} alt="Masoud" src="src/assets/react.svg" />
                        <Box>
                    ...
                    <Box sx={styles.commentRow}>
                        ...
                        <Box>
                            <Box sx={styles.commentDetailsSection}>
                                <Typography sx={styles.postMeta}>React with dred</Typography>
                                <Typography sx={styles.postMeta}>2 weeks ago</Typography>
                            </Box>
